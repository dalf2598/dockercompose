...
insert into public.INTEREST_RATE values(default, 'PASIVA CORRIENTE', 0.0, 'ACT', NOW(), null);
insert into public.PRODUCT_ACCOUNT values('CORR2023', 'Cuenta Corriente 2022', 'Cuenta corriente completamente autoegestionada y digital; no maneja cheques ni paga interes.', 0.0, 'N', 'N', 'ACT', NOW());